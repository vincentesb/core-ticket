...
/*
QueryBuilder represents a struct that holds various components for building SQL queries, such as
...
type QueryBuilder interface {
	...
	*/
	AndWhereRaw(rawSql string, params ...any) QueryBuilder
	...
	*/
	OrWhereRaw(rawSql string, params ...any) QueryBuilder
	...
	*/
	AndWhere(operator string, column interface{}, value interface{}) QueryBuilder
	...
	*/
	OrWhere(operator string, column interface{}, value interface{}) QueryBuilder
	...
	*/
	AndFilterWhere(operator string, column interface{}, value interface{}) QueryBuilder
	...
	*/
	OrFilterWhere(operator string, column interface{}, value interface{}) QueryBuilder
	...
	*/
	ConfigWhereCondition(condition map[string]query_helper.WhereCondition) QueryBuilder
	...
	*/
	ConfigInsert(insertConfig query_helper.InsertConfig) QueryBuilder
	...
	*/
	ConfigUpdate(updateConfig query_helper.UpdateConfig) QueryBuilder
	...
	/*
		...
		- QueryBuilder: the updated query builder instance
	*/
	AndWhereUsingCondition(column string) QueryBuilder
	...
	/*
		...
		- QueryBuilder: the updated query builder instance
	*/
	OrWhereUsingCondition(column string) QueryBuilder
	...
	*/
	AndFilterWhereUsingCondition(column string) QueryBuilder
	...
	*/
	OrFilterWhereUsingCondition(column string) QueryBuilder
	...
	*/
	...
	/*
		OrderByRaw sets the order condition for the SQL query.
		...
		This method is used to specify the order in which the query results should be returned.
	*/
	OrderByRaw(order string) QueryBuilder
	...
	*/
	AndHaving(operator string, column interface{}, value interface{}) QueryBuilder

	/*
		AndHavingRaw appends an 'AND' condition to the HAVING clause and adds a raw SQL string with parameters to the query builder.
		...
		- QueryBuilder: the query builder instance for method chaining.
	*/
	AndHavingRaw(rawSql string, params ...any) QueryBuilder
	...
	*/
	OrHaving(operator string, column interface{}, value interface{}) QueryBuilder
	...
	*/
	AndFilterHaving(operator string, column interface{}, value interface{}) QueryBuilder
	...
	*/
	OrFilterHaving(operator string, column interface{}, value interface{}) QueryBuilder
	...
	*/
	Limit(take int, skip int) QueryBuilder
	...
	*/
	BuildSQL(tableName string, buildType BuildType) (string, []interface{})
	...
	*/
	Build(tableName string, buildType BuildType) ([]string, []interface{})
	...
	*/
	From(tableName string, params ...any) QueryBuilder
	...
	*/
	AddWhereParams(params ...any) QueryBuilder
	...
	*/
	Join(joinType JoinType, tableName string, on string, params ...any) QueryBuilder
	...
	*/
	LeftJoin(tableName string, on string, params ...any) QueryBuilder
	...
	*/
	RightJoin(tableName string, on string, params ...any) QueryBuilder
	...
	*/
	InnerJoin(tableName string, on string, params ...any) QueryBuilder
	...
	*/
	CrossJoin(tableName string, on string, params ...any) QueryBuilder
	...
	*/
	BuildRawSQL(tableName string, buildType BuildType) string
}

/*
Expression represents a string expression used in the query builder for specifying raw SQL conditions or clauses.

Usage:
The Expression type is used in the query builder to provide raw SQL expressions for conditions or clauses.
...
func (bt BuildType) EnumIndex() int {
	return int(bt)
}

type JoinType int

// source: https://www.w3schools.com/mysql/mysql_join.asp
const (
...
func (jt JoinType) EnumIndex() int {
	return int(jt)
}
...
func (jt JoinType) Valid() bool {
	switch jt {
	case LeftJoin, RightJoin, InnerJoin, CrossJoin:
		return true
	}
	return false
}
